...
const RightSide = () => {
  ...
  return (
    <div
      className={`border-l border-slate-500 w-[40%] mx-auto items-center justify-between text-center ${
        selectedConversation ? "flex flex-col" : "hidden"
      }`}
    >
      {/* Section profile */}
      <div className="mx-auto flex flex-col items-center gap-3">
        <div className="chat-image avatar w-20 h-20 mx-auto rounded-full shadow-sm shadow-slate-500">
          <img
        ...
        <div className="flex gap-5 shadow-sm shadow-slate-500 w-auto p-2">
        ...
        {/* Section infos */}
        <div className="flex flex-col gap-3 shadow-sm shadow-slate-500 p-5 rounded-md">
      ...
      <div className="flex flex-col items-center w-full mb-0">
        <div className="divider w-1/2 mx-auto opacity-50"></div>
        <button className="btn btn-primary bottom-5">BLOCK</button>
      </div>
    </div>
  );
};
