            ...
            <main className="flex items-center gap-3">
              ...
              <span>
                <h3 className="font-semibold text-[#2A3D39] text-lg">
                  {selectedUser?.fullName || "Koragna User"}
                </h3>
                <p className="font-light text-[#2A3D39] text-sm">
                  @{selectedUser?.username || "koragna"}
                </p>
              </span>
            </main>
          </header>
        ...
        <section className="h-screen w-[100%] bg-[#e5f6f3]">
          <div className="flex flex-col justify-center items-center h-[100vh]">
            ...
            <h1 className="text-[30px] font-bold text-teal-700 mt-5">
              Bienvenu sur la plateforme Koragna
            </h1>
            <p className="text-gray-500">
              Connectez-vous, retrouver vos amies, et "Andao hikoragna ee !"
            </p>
          </div>
        </section>
      )}
